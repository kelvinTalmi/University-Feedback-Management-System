          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Courses List</h4>
                </div>
...
<td> <a href="update_course.php?id=<?php echo  $rows['id'] ?>" name="delete">Update</a>|<a  onclick="return confirm('Are you sure you want to delete this course?')" href="delete_course.php?id=<?php echo  $rows['id'] ?>" name="delete">Delete</a></td>
