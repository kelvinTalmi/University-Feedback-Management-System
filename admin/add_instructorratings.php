...
$result=mysqli_query($conn,"INSERT INTO instructor_questions (question) VALUES  ('$question')");

if($result){

echo "<script>alert(' Instructor questions added Successfully')</script>";
}else{
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Add Instructor Questions</h4>
                </div>
...
<div  class="card">
<center><div class="card-header">Add Instructor Questions</div></center>
<div class="card-body">
