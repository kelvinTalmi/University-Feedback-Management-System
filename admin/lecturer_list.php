          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Lecturers List</h4>
                </div>
...
<thead  class="record">
  ...
  <td style="font-weight:bold">Name</td>
    <td style="font-weight:bold">Unique No</td>
...
<td> <?php echo  $rows['unique_no'] ?></td>
<td> <?php echo  $rows['email'] ?></td>
<td> <?php echo  $rows['department'] ?></td>

<td> <a href="update_lecturer.php?id=<?php echo  $rows['id'] ?>" name="delete">Update</a>|<a  onclick="return confirm('Are you sure you want to delete this course?')" href="delete_lecturer.php?id=<?php echo  $rows['id'] ?>" name="delete">Delete</a></td>
