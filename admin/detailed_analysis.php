...
<div  class="card">
<center><div class="card-header"><?php echo $name ?></div></center>
<div class="card-body">
...
<?php
$points=mysqli_query($conn,"SELECT * FROM feedback WHERE lecturer='$unique_no' AND course='$course'");
$i=0;
...
$points3=mysqli_query($conn,"SELECT sum(score) AS totalscore FROM feedback WHERE lecturer='$unique_no' AND course='$course' AND question='$question'");
...
$pointn=$points4['totalscore'];
  $points5=mysqli_query($conn,"SELECT distinct(adm_no) FROM feedback WHERE lecturer='$unique_no' AND course='$course'");
