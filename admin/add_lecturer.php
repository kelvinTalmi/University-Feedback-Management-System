...
if($name==""||$unique_no==""||$email==""||$department=="")
{
...
$result=mysqli_query($conn,"INSERT INTO lecturer (name,unique_no,email,department) VALUES  ('$name','$unique_no','$email','$department')");
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Add Lecturers</h4>
                </div>
...
<div  class="card">
<center><div class="card-header">Add Lecturer</div></center>
<div class="card-body">
...
<input type="text"  name="unique_no" class="form-control" required><br>

<label>Email</label>
<input type="email"  name="email" id="emailid" class="form-control" onchange="checkAvailability()" required >
