...
$result=mysqli_query($conn,"INSERT INTO department (department_name,hod) VALUES  ('$department','$hod')");
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Add Department</h4>
                </div>
...
<div  class="card">
<center><div class="card-header">Add Department</div></center>
<div class="card-body">
...
<input type="text" id="email" name="hod" class="form-control" required><br>
