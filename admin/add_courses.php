...
$result=mysqli_query($conn,"INSERT INTO courses (course_title,course_code,department,year_of_study,semester) VALUES  
  ('$title','$code','$department','$yos','$semester')");
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Add Courses</h4>
                </div>
...
<div  class="card">
<center><div class="card-header">Add Courses</div></center>
<div class="card-body">
...
<input type="text" id="email" name="code" class="form-control" required><br>
