...
if($name==""||$email==""||$unique_no==""||$department=="")
{
echo "<script>alert('Some fields are empty') </script>";

}else{

$result=mysqli_query($conn,"UPDATE lecturer set name='$name',email='$email',unique_no='$unique_no',department='$department' where id=$update" );

if($result){

echo "<script>alert('lecturer Updated Successfully')</script>";
}else{
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Update lecturer</h4>
                </div>
...
<div  class="card">
<center><div class="card-header">Update Lecturer</div></center>
<div class="card-body">
...
$result3=mysqli_query($conn,"SELECT *FROM lecturer where id=$update");
...
<input type="text"  value="<?php echo $rows2['unique_no']  ?>" name="unique_no" class="form-control" required><br>
