...
$result=mysqli_query($conn,"UPDATE department set department_name='$department',hod='$hod' where id=$update" );
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Update Department</h4>
                </div>
...
<div  class="card">
<center><div class="card-header">Update Department</div></center>
<div class="card-body">
...
$result3=mysqli_query($conn,"SELECT *FROM department where id=$update");
...
<input type="text"  name="department"  value="<?php echo $rows2['department_name']  ?>" class="form-control" required ><br>

<label>Head of Department</label>
<input type="text"  value="<?php echo $rows2['hod']  ?>" name="hod" class="form-control" required><br>
