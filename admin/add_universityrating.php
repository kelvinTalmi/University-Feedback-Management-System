...
$result=mysqli_query($conn,"INSERT INTO university_questions (question) VALUES  ('$question')");
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Add University Evaluation Questions</h4>
                </div>
...
<div  class="card">
<center><div class="card-header">Add </div></center>
<div class="card-body">
