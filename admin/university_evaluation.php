          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">University Analysis</h4>
                </div>
...
<div  class="card">
<center><div class="card-header">University Evaluation </div></center>
<div class="card-body">
...
<?php
$points=mysqli_query($conn,"SELECT * FROM university_feedback");
$i=0;
...
$points3=mysqli_query($conn,"SELECT sum(score) AS totalscore FROM university_feedback WHERE  question='$question'");
...
<td>   <?php
  ...
  $points5=mysqli_query($conn,"SELECT distinct(adm_no) FROM university_feedback ");
