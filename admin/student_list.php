          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Students List</h4>
                </div>
...
<td> <?php echo  $rows['adm_no'] ?></td>
<td> <?php echo  $rows['email'] ?></td>
<td> <?php echo  $rows['phone_number'] ?></td>

<td> <a href="update_student.php?id=<?php echo  $rows['id'] ?>" name="delete">Update</a>|<a  onclick="return confirm('Are you sure you want to delete this course?')" href="delete_student.php?id=<?php echo  $rows['id'] ?>" name="delete">Delete</a></td>
